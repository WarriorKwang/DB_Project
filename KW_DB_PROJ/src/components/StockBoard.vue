<template>
	<div>
      ...
      <div class="mb-5 pb-5 border-gray-600 border-b">
        <h1 class="mb-4 text-2xl font-extrabold text-gray-900 dark:text-white md:text-4xl lg:text-5xl">
          <span
              class="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">KOSPI</span> 주식목록</h1>
        <p class="text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400">대한민국의 제1 증권시장에서 투자하세요</p>
      </div>
      ...
      <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        ...
        <tbody>
        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700" v-for="stock in stockList" :key="stock.code">
...
<!--              <router-link :to="{ name: 'user', params: { userId: 123 }}">User</router-link>-->
              <router-link :to="{name: 'stock', params: {page: pageLookup.cur - 1}}"
            ...
            <li class="py-2" v-for="p_idx in pageLookup.top - pageLookup.bottom + 1" v-bind:key="p_idx">
              <router-link :to="{name: 'stock', params: {page: p_idx + pageLookup.bottom - 1}}" v-if="pageLookup.cur ===
            p_idx + pageLookup.bottom - 1"
              ...
              <router-link :to="{name: 'stock', params: {page: p_idx + pageLookup.bottom - 1}}" v-else
